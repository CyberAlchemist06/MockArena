...
public class ApiExceptionHandler {
    ...
    @ExceptionHandler({org.springframework.web.bind.MethodArgumentNotValidException.class, org.springframework.web.method.annotation.MethodArgumentTypeMismatchException.class, org.springframework.http.converter.HttpMessageNotReadableException.class, IllegalArgumentException.class}) @ResponseStatus(HttpStatus.BAD_REQUEST)
    ...
    @ExceptionHandler(PublicCatalogueUnavailableException.class) @ResponseStatus(HttpStatus.SERVICE_UNAVAILABLE) ErrorResponse catalogueUnavailable(PublicCatalogueUnavailableException exception) { return new ErrorResponse("CATALOGUE_UNAVAILABLE", "Assessment catalogue is temporarily unavailable"); }
    ...
    @ExceptionHandler(ResultNotReleasedException.class) @ResponseStatus(HttpStatus.CONFLICT) ErrorResponse resultNotReleased(ResultNotReleasedException exception) { return new ErrorResponse("RESULT_NOT_RELEASED", "Result is not available yet"); }
