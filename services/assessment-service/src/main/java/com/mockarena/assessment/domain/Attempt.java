...
public class Attempt {
    ...
    public void submit(Instant now) { if (status != AttemptStatus.IN_PROGRESS) throw new IllegalStateException("Attempt is not in progress"); status = AttemptStatus.SUBMITTED; submittedAt = now; updatedAt = now; }
