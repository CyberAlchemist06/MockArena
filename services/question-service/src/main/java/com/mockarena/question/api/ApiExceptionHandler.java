...
public class ApiExceptionHandler {
    ...
    @ExceptionHandler(IllegalArgumentException.class) @ResponseStatus(HttpStatus.BAD_REQUEST) ErrorResponse invalidContent(IllegalArgumentException e) { return new ErrorResponse("VALIDATION_ERROR", "Request validation failed"); }
