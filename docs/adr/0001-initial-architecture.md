...
Build V1 as four deployable Java 21 and Spring Boot services: Identity Service, Question Service, Assessment Service, and Evaluation Service. Use a Next.js and TypeScript frontend. Ranking is a module within Assessment Service for V1.
...
The platform needs explicit ownership for identity, question content, assessment/ranking, and untrusted-code evaluation from the outset. It also needs transactional correctness for assessments and results, low-latency reads for active sessions and leaderboards, and asynchronous processing for submissions.
